  ...
  return (
    <div className="overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl animate-fade-in-up">
            <div className="inline-block mb-4 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
              <span className="text-sm font-medium">✨ Sản phẩm cao cấp - Dịch vụ chuyên nghiệp</span>
            </div>
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
              <span className="block whitespace-nowrap">Cổng Nhôm Đúc Hùng Phát</span>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/san-pham"
                className="bg-white text-primary-700 px-8 py-4 rounded-xl font-semibold hover:shadow-2xl hover:scale-105 transition-all duration-300 text-center shadow-lg"
              >
                Xem Sản Phẩm →
              </Link>
              <Link
                href="/bao-gia"
                className="bg-transparent border-2 border-white/50 text-white px-8 py-4 rounded-xl font-semibold hover:bg-white/10 hover:border-white hover:scale-105 transition-all duration-300 text-center backdrop-blur-sm"
              >
                Yêu Cầu Báo Giá
              </Link>
            </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 animate-fade-in-up">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900">Sản Phẩm Nổi Bật</h2>
          ...
          <div className="text-center mt-16">
            <Link
              href="/san-pham"
              className="inline-block luxury-gradient text-white px-10 py-4 rounded-xl font-semibold hover:shadow-2xl hover:scale-105 transition-all duration-300 shadow-lg"
            >
              Xem Tất Cả Sản Phẩm →
            </Link>
          </div>
      ...
      <section className="py-24 luxury-gradient-dark text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-8 animate-fade-in-up">Về Chúng Tôi</h2>
            <div className="w-24 h-1 bg-white/30 mx-auto rounded-full mb-8"></div>
            <p className="text-lg md:text-xl text-gray-200 mb-6 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            ...
            <p className="text-lg md:text-xl text-gray-200 mb-12 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                <div className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary-300 to-primary-100 mb-3">500+</div>
                <div className="text-gray-200 font-medium">Dự án đã hoàn thành</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                <div className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary-300 to-primary-100 mb-3">10+</div>
                <div className="text-gray-200 font-medium">Năm kinh nghiệm</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                <div className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary-300 to-primary-100 mb-3">100%</div>
                <div className="text-gray-200 font-medium">Khách hàng hài lòng</div>
              </div>
            </div>
          </div>
        </div>
